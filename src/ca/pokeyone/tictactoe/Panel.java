...
public class Panel extends JPanel implements Runnable, KeyListener, MouseListener{
    ...
    public Panel(){
        ...
        stateManager.addState(new StateMenu("Mode Menu",
                new StateMenu.MenuOption("3x3", Constants.STATE_UID_3X3_MENU, Constants.SOUND_GAME_3),
                new StateMenu.MenuOption("9x9", Constants.STATE_UID_9X9_MENU, Constants.SOUND_GAME_9)
